...
def func(A,t): #A = [x, y, Vx, Vy]
    ...
    dVxdt = F12[0] / m1
    dVydt = F12[1] / m1
    r = 1000*9461000000000
    dVzdt = -(G*(m2/550)/r**2)*(A[2]/r)
    return [dxdt, dydt, dzdt, dVxdt, dVydt,dVzdt]
    

m1 = 2 * 10**30 #kg massa do sol
m2 = (2 * 11**10)*m1   #kg massa de Jupiter
#m3 =(2*11**11)*m1
...
y0 = 0
Vx0 = 0
Vy0 = 220 * 10**3 #m/s, velocidade orbital de jupiter
z0 = 100*9461000000000
Vz0 = 200000000
A0 = [x0,y0,z0,Vx0,Vy0,Vz0]
T = linspace(0,11**10*4.658,5000)
M = odeint(func,A0,T)
fig = plt.figure()
